...
class GetURIDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.label_help = wx.StaticText(self, -1, "I can try to determine PN and PVR from the package URI.")
        self.label_help2 = wx.StaticText(self, -1, "Enter the package URI and press the 'Test Package' button.")
    ...
    def __do_layout(self):
        ...
        sizer_main.Add(self.static_line_3, 0, wx.TOP|wx.BOTTOM|wx.EXPAND, 10)
        sizer_main.Add(self.label_help, 0, wx.LEFT|wx.ADJUST_MINSIZE, 4)
        sizer_main.Add(self.label_help2, 0, wx.LEFT|wx.ADJUST_MINSIZE, 4)
        ...
        sizer_main.Add(self.static_line_4, 0, wx.TOP|wx.BOTTOM|wx.EXPAND, 10)
    ...
    def OnTestP(self, event): # wxGlade: GetURIDialog.<event_handler>
        ...
        print "uri", uri
        if not uri:
            self.SetWarning("Enter the package URI")
            return
