...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.checkbox_xterm_log = wx.CheckBox(self.noteboo_pane_general, -1, "External cmds run in xterm instead of log window (compile etc)")
        self.radio_box_log = wx.RadioBox(self.noteboo_pane_general, -1, "Log placement", choices=["Middle", "Top Left", "Top Right", "Bottom in Notebook"], majorDimension=0, style=wx.RA_SPECIFY_COLS)
        self.label_1 = wx.StaticText(self.noteboo_pane_general, -1, "Log placement will change after restarting Abeni")
        ...
        self.label_2 = wx.StaticText(self.noteboo_pane_editor, -1, "Tab placement will change after restarting Abeni")
    ...
    def __set_properties(self):
        ...
        self.checkbox_xterm_log.SetValue(1)
    ...
    def __do_layout(self):
        ...
        sizer_9.Add(self.checkbox_xterm_log, 0, wx.LEFT|wx.ADJUST_MINSIZE, 8)
        sizer_8.Add(sizer_9, 0, wx.EXPAND, 0)
        sizer_19.Add(self.radio_box_log, 0, wx.TOP|wx.ADJUST_MINSIZE, 6)
        sizer_19.Add(self.label_1, 0, wx.TOP|wx.ADJUST_MINSIZE, 6)
        ...
        sizer_20.Add(self.radio_box_tab, 0, wx.TOP|wx.ADJUST_MINSIZE, 10)
        sizer_20.Add(self.label_2, 0, wx.TOP|wx.ADJUST_MINSIZE, 27)
